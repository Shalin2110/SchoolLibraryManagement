...
public class ReturnBookForm extends javax.swing.JFrame {
    ...
    private void btnCheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckActionPerformed
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM issuebook WHERE BookId = '"+BookId+"' AND StudentId = '"+StId+"'");
            if(rs.next()){
    ...
    private void btnReturnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReturnActionPerformed
        if(valReturn()){
            ...
            try {
                ...
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/librarymanagement","root","21101105");
                Statement st = con.createStatement();
                st.executeUpdate("UPDATE issuebook SET Status = 'Returned' WHERE BookId = '"+BookId+"' AND StudentId = '"+StId+"'");
